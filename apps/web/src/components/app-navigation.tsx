...
const navigation=[["⌂","Overview","/"],["◇","Inventory","/inventory"],["⇩","Inbound","/inbound"],["⇧","Outbound","/outbound"],["♜","Tasks","/tasks"],["▤","Production","/catalog"],["⌾","Locations","/locations"],["▥","Reports","/deliveries"],["⚙","Settings","/settings"]] as const;
